...
package_target() {
  ...
  printf '{"package":"zed-yolo","version":"%s","channel":"%s","target":"%s","filename":"%s","sha256":"%s","seconds":%s,"commit":"%s","build":"%s","date":"%s","runtime_shaders":%s,"binaries":"%s","runner_cpus":"%s","runner_memory_gib":"%s","cargo_build_jobs":"%s","benchmark":"%s"}\n' \
